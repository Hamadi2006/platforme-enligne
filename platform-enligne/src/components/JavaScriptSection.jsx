...
export default function JavaScriptSection() {
  const JavaScriptLessons = useSelector((state) => state.JavaScriptState);
  const [selectedLesson, setSelectedLesson] = useState(null);

  const trackData = JavaScriptLessons && JavaScriptLessons[0];
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        ...
        <header className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">
            {trackData?.track || 'JavaScript Fundamentals'}
          </h1>
          <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
            {trackData?.description || 'Learn the core language for web interactivity.'}
          </p>
        </header>
