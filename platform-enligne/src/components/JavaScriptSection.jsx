function JavaScriptSection() {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 p-8 md:p-12 mb-8 shadow-2xl">
      ...
      <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 lg:p-10 mb-8 border border-slate-800/50 shadow-xl">
        ...
        <p className="text-slate-300 text-base md:text-lg leading-relaxed">
          JavaScript is a programming language that allows you to implement complex features on web pages. Every time a web page does more than just sit there and display static information, JavaScript is probably involved.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {['Variables & Data Types', 'Functions', 'DOM Manipulation', 'ES6+ Features'].map((topic, index) => (
          <div key={index} className="group bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 border border-slate-800/50 hover:border-slate-700 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer shadow-lg">
            ...
            <p className="text-slate-400 text-sm">Build dynamic, interactive experiences</p>
          </div>
        ))}
      </div>
    </div>
