export default function HTMLSection() {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 p-8 md:p-12 mb-8 shadow-2xl">
      ...
      <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 lg:p-10 mb-8 border border-slate-800/50 shadow-xl">
        ...
        <p className="text-slate-300 text-base md:text-lg leading-relaxed">
          Every website you visit is built with HTML at its core. It's the foundation that holds everything together.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {['Elements & Tags', 'Semantic HTML', 'Forms', 'Accessibility'].map((topic, index) => (
            <div key={index} className="group bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 border border-slate-800/50 hover:border-slate-700 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-2xl">
              ...
              <p className="text-slate-400 text-sm">Master HTML fundamentals and best practices</p>
            </div>
          ))}
        </div>
      </div>
