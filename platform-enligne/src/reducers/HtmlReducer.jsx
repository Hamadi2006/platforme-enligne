...
const initialState = [{
    track: "HTML Fundamentals",
    version: "1.0",
    language: "en",
    totalLessons: 8,
    estimatedHours: 2.5,
    difficulty: "beginner",
    description: "Master the fundamentals of HTML and build a solid foundation for web development",
    lessons: [
        {
            id: "html-001",
            title: "What is HTML?",
            ...
            objectives: [
                ...
                "Know what an element and tag are",
                "Recognize basic page structure"
            ],
  ...
  <body>
    ...
    <p>This is a paragraph.</p>
...

        {
            ...
            completed: false,
            objectives: [
                "Know the roles of <head> and <body>",
                "Use meta tags",
...
<html lang="en">
  ...
  <body>
    ...
    <p>Visible content goes here.</p>
        ...
        {
            id: "html-003",
            title: "Text Elements (Headings, Paragraphs, Lists)",
            level: "beginner",
            durationMin: 12,
            completed: false,
            objectives: [
  ...
  <li>Open in browser</li>
...

        {
            ...
            objectives: [
                ...
                "Add images with <img>",
                "Write good alt text for accessibility"
            ],
...
<a href="gallery.html">
  <img src="thumbnail.jpg" alt="Photo gallery thumbnail" />
...

        {
            ...
            completed: false,
            objectives: [
                "Understand <form> action and method",
                "Use inputs (text, email, password)",
...
Always connect labels to inputs with for="id" for better accessibility!`,
  ...
  <button type="submit">Create Account</button>
...

        {
            ...
            completed: false,
            objectives: [
                "Know what semantic elements are",
    ...
    <p>© 2026 Jane Developer</p>
...

        {
            ...
            objectives: [
                ...
                "Style tables with scope and caption"
            ],
      ...
      <td>A-</td>
...

        {
            ...
            objectives: [
                ...
                "Understand video and audio elements",
...
export default HtmlReducer.reducer ; 
